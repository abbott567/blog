...
![Data visualisation an example service called adopt a cheetah. As described in the previous paragraph.](/images/work/accessibility-reporting-evidence.jpg)
...
![A pyramid with 4 tiers, labelled from bottom to top as: products or teams, product development units, directorates, organisation.](/images/work/accessibility-reporting-pyramid.jpg)
...
![A pyramid with 4 tiers, labelled from bottom to top as: products or teams, product development units, directorates, organisation.](/images/work/accessibility-reporting-structure.jpg)
...
![A full page screen shot of the accessibility report. It shows all of the bits already covered, but also shows a side navigation menu for moving between the different directorates and PDUs.](/images/work/accessibility-reporting-full.jpg)
